...
/**
 * Класс определяет с методами преобразования объекта класса <b>{@link User}</b> в DTO класса <b>{@link UserDto}</b> и наоборот.
 *
 * @author Igor Ivanov
 */
@Component
public class UserMapper implements MapperDTO<User, UserDto> {
    ...
    /**
     * Метод преоброзования DTO объекта класса {@link UserDto} в объект класса {@link User}.
     *
